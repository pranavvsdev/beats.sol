...
contract ERC20 {
    ...
    string public name = "Beats";
    string public symbol = "BTS";
    uint8 public decimals = 18;
    uint internal code=4712;

    string public shop_items="Redeemable items : 1. Degen Drink 2. Degen fan 3. Degen Outfit 4. Degen Shades";
    string public discount="Enter 0 if you do not have a discount code";
    ...
    function redeem(uint256 redeem_number, uint discount_code) public balance_check {
        ...
        if(discount_code==code){
            burn(redeem_number*250);
            
        }
        else{
            burn(redeem_number*500);
        }
